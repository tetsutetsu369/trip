...
type LinkableMember = { id: string; name: string; status: "pending" | "approved" };

export default function ParticipantManager({ trip, participants, linkableMembers }: { trip: string; participants: Participant[]; linkableMembers: LinkableMember[] }) {
