...
const header = (role = "member") => `<header class="trip-header"><a class="trip-header-brand" href="${base}/"><span class="trip-header-mark">TJ</span><span><strong>Trip Journal</strong><small>四国三郎の郷 BBQ旅</small></span></a><nav class="trip-header-nav"><a class="is-active" href="${base}/">ポータル</a><a href="${link("itinerary/")}">旅程</a><a href="${link()}">費用</a><a href="${link("packing/")}">持ち物</a><a href="${link("notes/")}">メモ</a>${role === "admin" ? `<a class="admin-link" href="${link("admin/")}">管理</a>` : ""}<a class="trip-header-user" href="${link("profile/")}" aria-label="プロフィールを編集" title="プロフィールを編集"><span>👤</span></a></nav></header>`;
